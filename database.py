...
class Database:
    def __init__(self, db_path=None):
        """Инициализация базы данных для Render с Disk и connection pooling"""
        self.db_path = self._init_db_path(db_path)
        self._connection_pool = queue.Queue(maxsize=5)
        self._pool_lock = threading.Lock()
        self._init_pool()
        self.init_db()
        logger.info(f"✅ База данных инициализирована с connection pooling: {self.db_path}")
    
    def _init_db_path(self, db_path):
    ...
    def _init_pool(self):
        ...
        for _ in range(2):  # Начальные 2 соединения
        ...
        for attempt in range(max_retries):
            try:
                ...
                if attempt < max_retries - 1:
                    logger.warning(f"⚠️ Не удалось создать соединение, попытка {attempt + 1}/{max_retries}: {e}")
                    import time
                    time.sleep(retry_delay * (attempt + 1))
                    continue
                else:
                    logger.error(f"❌ Критическая ошибка создания соединения после {max_retries} попыток: {e}")
                    return None
    ...
    def get_connection(self):
        ...
        try:
            ...
            try:
                ...
                conn = self._create_optimized_connection()
                if not conn:
                    raise Exception("Не удалось создать соединение с БД")
            ...
            if conn:
                try:
                    # Health check соединения перед возвратом в пул
                    ...
                    # Соединение нерабочее, закрываем его
                    try:
                        conn.close()
                    except:
                        pass
    ...
    # ===== ОСТАЛЬНЫЕ МЕТОДЫ (обновленные с новым connection pooling) =====
    ...
    def get_users_with_bot_started(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении пользователей с bot_started: {e}")
            return []
    ...
    def get_welcome_message(self):
        ...
        try:
            ...
            return {'text': "Добро пожаловать!", 'photo': None}
    ...
    def get_goodbye_message(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении прощального сообщения: {e}")
            return {'text': "До свидания!", 'photo': None}
    ...
    def set_goodbye_message(self, message, photo_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при установке прощального сообщения: {e}")
    ...
    def get_welcome_buttons(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении кнопок приветствия: {e}")
            return []
    ...
    def add_welcome_button(self, button_text, position=1):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при добавлении кнопки приветствия: {e}")
            return None
    ...
    def update_welcome_button(self, button_id, button_text=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при обновлении кнопки приветствия: {e}")
    ...
    def get_welcome_button_by_text(self, button_text):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении кнопки приветствия по тексту: {e}")
            return None
    ...
    def delete_welcome_button(self, button_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при удалении кнопки приветствия: {e}")
    ...
    def get_welcome_follow_messages(self, welcome_button_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении последующих сообщений: {e}")
            return []
    ...
    def add_welcome_follow_message(self, welcome_button_id, text, photo_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при добавлении последующего сообщения: {e}")
            return None
    ...
    def update_welcome_follow_message(self, message_id, text=None, photo_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при обновлении последующего сообщения: {e}")
    ...
    def delete_welcome_follow_message(self, message_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при удалении последующего сообщения: {e}")
    ...
    def get_goodbye_buttons(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении кнопок прощания: {e}")
            return []
    ...
    def get_goodbye_button_by_text(self, button_text):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении кнопки прощания по тексту: {e}")
            return None
    ...
    def add_goodbye_button(self, button_text, button_url):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при добавлении кнопки прощания: {e}")
            return None
    ...
    def update_goodbye_button(self, button_id, button_text=None, button_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при обновлении кнопки прощания: {e}")
    ...
    def delete_goodbye_button(self, button_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при удалении кнопки прощания: {e}")
    ...
    def get_scheduled_broadcasts(self, include_sent=False):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении запланированных рассылок: {e}")
            return []
    ...
    def add_scheduled_broadcast(self, message_text, scheduled_time, photo_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при добавлении запланированной рассылки: {e}")
            return None
    ...
    def delete_scheduled_broadcast(self, broadcast_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при удалении запланированной рассылки: {e}")
    ...
    def mark_broadcast_sent(self, broadcast_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при отметке рассылки как отправленной: {e}")
    ...
    def get_pending_broadcasts(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении готовых рассылок: {e}")
            return []
    ...
    def get_scheduled_broadcast_buttons(self, broadcast_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении кнопок рассылки: {e}")
            return []
    ...
    def add_scheduled_broadcast_button(self, broadcast_id, button_text, button_url, position=1):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при добавлении кнопки к рассылке: {e}")
    ...
    def delete_scheduled_broadcast_button(self, button_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при удалении кнопки рассылки: {e}")
    ...
    def get_broadcast_message(self, message_number):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении сообщения рассылки: {e}")
            return None
    ...
    def get_all_broadcast_messages(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении всех сообщений рассылки: {e}")
            return []
    ...
    def add_broadcast_message(self, text, delay_hours, photo_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при добавлении сообщения рассылки: {e}")
            return None
    ...
    def delete_broadcast_message(self, message_number):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при удалении сообщения рассылки: {e}")
    ...
    def update_broadcast_message(self, message_number, text=None, delay_hours=None, photo_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при обновлении сообщения рассылки: {e}")
    ...
    def add_message_button(self, message_number, button_text, button_url, position=1):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при добавлении кнопки к сообщению: {e}")
    ...
    def update_message_button(self, button_id, button_text=None, button_url=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при обновлении кнопки сообщения: {e}")
    ...
    def delete_message_button(self, button_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при удалении кнопки сообщения: {e}")
    ...
    def get_message_buttons(self, message_number):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении кнопок сообщения: {e}")
            return []
    ...
    def get_broadcast_status(self):
        ...
        try:
            ...
            return {'enabled': True, 'auto_resume_time': None}
    ...
    def set_broadcast_status(self, enabled, auto_resume_time=None):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при установке статуса рассылки: {e}")
    ...
    def get_pending_messages(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении готовых сообщений: {e}")
            return []
    ...
    def get_pending_messages_for_active_users(self):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении готовых сообщений для активных пользователей: {e}")
            return []
    ...
    def get_user_scheduled_messages(self, user_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при получении запланированных сообщений пользователя: {e}")
            return []
    ...
    def cancel_user_messages(self, user_id):
        ...
        try:
            ...
            logger.error(f"❌ Ошибка при отмене сообщений пользователя: {e}")
