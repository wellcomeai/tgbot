...
class MessagesMixin:
    ...
    async def show_welcome_edit(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        personalization_info = (
            ...
            "• <code>{username}</code> - никнейм (@username) или имя\n"
    ...
    async def show_success_message_edit(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Получаем статус включения/выключения
        ...
        personalization_info = (
            ...
            "• <code>{last_name}</code> - фамилия пользователя\n\n"
            "<b>💡 Пример:</b>\n"
            "<i>Отлично, {first_name}! 🎉\n"
            "Спасибо за подписку, {username}!</i>"
        )
...
### 1. **Приветственное сообщение** (`show_welcome_edit`)
- Секция "🎯 Персонализация" с описанием переменных
- Пример использования: `Привет, {username}! 👋`
- Работает в обоих вариантах метода (edit и from_context)

### 2. **Прощальное сообщение** (`show_goodbye_edit`)
- Та же секция персонализации
- Пример: `До свидания, {first_name}! 😢`
- Работает в обоих вариантах метода

### 3. **Сообщение подтверждения** (`show_success_message_edit`)
- Добавлена информация о персонализации
- Пример: `Отлично, {first_name}! 🎉`
- Работает в обоих вариантах метода

### 4. **Визуальное оформление**
Подсказки отображаются как:
```
🎯 Персонализация:
Вы можете использовать переменные:
- {username} - никнейм (@username) или имя
- {first_name} - имя пользователя
- {last_name} - фамилия пользователя

💡 Пример:
Привет, {username}! 👋
{first_name}, рад видеть тебя в нашем канале!
