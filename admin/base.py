...
class AdminBaseMixin:
    ...
    async def request_text_input(self, update: Update, context: ContextTypes.DEFAULT_TYPE, 
        ...
        prompt_texts = {
            ...
            "welcome_video": "🎥 Отправьте видео напрямую или ссылку на видео (http://...):",
            "goodbye": "✏️ Отправьте новый текст прощального сообщения:",
            "goodbye_photo": "🖼 Отправьте фото напрямую или ссылку на фото (http://...):",
            "goodbye_video": "🎥 Отправьте видео напрямую или ссылку на видео (http://...):",
            ...
            "broadcast_video": f"🎥 Отправьте видео для сообщения {message_number} напрямую или ссылку (http://...):" if message_number else "🎥 Отправьте видео:",
            ...
            "mass_video": "🎥 Отправьте видео напрямую или ссылку на видео (http://...):",
            ...
            "payment_message_video": "🎥 Отправьте видео напрямую или ссылку на видео (http://...):",
            ...
            "renewal_video": "🎥 Отправьте видео напрямую или ссылку на видео (http://...):",
            ...
            "paid_broadcast_video": f"💰 🎥 Отправьте видео для сообщения оплативших {message_number} напрямую или ссылку (http://...):",
            ...
            "paid_mass_video": "💰 🎥 Отправьте видео напрямую или ссылку на видео (http://...):",
        ...
        elif input_type.startswith("payment_message"):
